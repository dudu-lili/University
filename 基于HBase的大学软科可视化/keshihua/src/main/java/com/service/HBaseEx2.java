...
//import org.apache.hadoop.hbase.filter.RowFilter;
//import org.apache.hadoop.hbase.util.Bytes;
//public class HBaseEx2 {
//    static HBaseAdmin hbaseAdmin = null;
//    static Configuration hbaseConf = null;
//    public static void main(String[] args) throws IOException{
//        Configuration conf = new Configuration();
//        conf.set("hbase.zookeeper.quorum","master,s1,s2");
//        hbaseConf = HBaseConfiguration.create(conf);
//        hbaseAdmin = new HBaseAdmin(hbaseConf);
//        HTable table = new HTable(hbaseConf,"scores");
//        List<Filter>filters = new ArrayList<Filter>();
//        Filter filter1 = (Filter) new RowFilter(CompareOperator.EQUAL,new RegexStringComparator("610"));
//        filters.add(filter1);
//        Filter filter2 = (Filter) new RowFilter(CompareOperator.GREATER_OR_EQUAL,new BinaryComparator(Bytes.toBytes("86")));
//        filters.add(filter2);
