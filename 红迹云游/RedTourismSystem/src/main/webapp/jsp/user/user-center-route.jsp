...
<%--        </li>--%>
        <li class="nav-item" role="presentation">
            ...
            <button class="nav-link active nav-pills-button" id="pills-route-favorites-tab" data-bs-toggle="pill" data-bs-target="#pills-route-favorites" type="button" role="tab" aria-controls="pills-route-favorites" aria-selected="true">我的路线收藏</button>
        </li>
        <li class="nav-item" role="presentation">
    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade show active" id="pills-route-favorites" role="tabpanel">
