...
<div class="container mt-4">
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link nav-pills-button" href="user-center-travelnotes.jsp">我的游记收藏</a>
        </li>
        <li class="nav-item" role="presentation">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link active nav-pills-button" id="pills-mytravelnotes-tab" data-bs-toggle="pill" data-bs-target="#pills-mytravelnotes" type="button" role="tab" aria-controls="pills-mytravelnotes" aria-selected="true">我的游记</button>
        </li>
    </ul>
    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade" id="pills-travelnotes-favorites" role="tabpanel">
        ...
        <div class="tab-pane fade show active" id="pills-mytravelnotes" role="tabpanel">
            <h5 class="mb-4">我的游记</h5>
            <div class="row">
                <c:forEach var="travelNotes" items="${mytravelNotesList}">
                    <div class="col-md-4">
                        <div class="card">
                            <img src="${pageContext.request.contextPath}/${travelNotes.banImage}" class="card-img-top" alt="${travelNotes.title}">
                            <div class="card-body">
                                ...
                                <p class="card-text">ID: ${travelNotes.id}</p>
                                <div class="d-flex justify-content-between">
                                    <button class="btn btn-sm btn-outline-danger" onclick="deleteTravelNotes(${travelNotes.id})">删除</button>
                                    <button class="btn btn-sm btn-outline-primary" onclick="editTravelNotes(${travelNotes.id})">编辑</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function deleteTravelNotes(travelNotesId) {
        if (confirm('确定要删除这条游记吗？')) {
            const activeTab = document.querySelector('.nav-pills .nav-link.active').getAttribute('id');
            localStorage.setItem('activeTab', activeTab);

            fetch('${pageContext.request.contextPath}/travelNotes/deletemytravelnotes/' + travelNotesId, { method: 'DELETE' })
    ...
    function editTravelNotes(travelNotesId) {
        window.location.href = 'travelnotes-edit.jsp?id=' + travelNotesId;
    }
