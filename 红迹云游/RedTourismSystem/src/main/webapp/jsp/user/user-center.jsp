...
<div class="container mt-4">
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active nav-pills-button" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="true">个人信息</button>
        </li>
        <li class="nav-item" role="presentation">
        ...
        fetch('${pageContext.request.contextPath}/user/uploadAvatar', {
            ...
            .then(data => {
                if (data.code === 200) {
                    ...
                    avatarPreview.src = '${pageContext.request.contextPath}/user/avatar/${user.id}?t=' + new Date().getTime();

                    const navbarAvatar = document.querySelector('.navbar .avatar-circle');
                    if (navbarAvatar) {
                        navbarAvatar.src = '${pageContext.request.contextPath}/user/avatar/${user.id}?t=' + new Date().getTime();
                    }
                } else {
