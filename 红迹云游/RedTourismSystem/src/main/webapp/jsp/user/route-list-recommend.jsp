    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="route-list-recommend.jsp">路线智荐</a>
                </li>
...
<div class="container mt-4">
    ...
    <div class="row" id="routeListContainer">
        <c:forEach var="route" items="${recommendedRoutes}" varStatus="status">
...
<script>
    ...
    function initRouteStatus() {
        $('.route-card').each(function() {
            ...
            const likeButton = $(this).find('.btn-like');
            const favoriteButton = $(this).find('.btn-favorite');
    ...
    function toggleFavorite(button) {
        ...
        const routeId = favoriteButton.closest('.route-card').data('route-id');
