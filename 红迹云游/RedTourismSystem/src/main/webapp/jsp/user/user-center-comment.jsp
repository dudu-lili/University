...
<%--    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">--%>
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
     ...
     <li class="nav-item" role="presentation">
            <button class="nav-link active nav-pills-button" id="pills-comments-tab" data-bs-toggle="pill" data-bs-target="#pills-comments" type="button" role="tab" aria-controls="pills-comments" aria-selected="true">我的评论</button>
        </li>
        <li class="nav-item" role="presentation">
