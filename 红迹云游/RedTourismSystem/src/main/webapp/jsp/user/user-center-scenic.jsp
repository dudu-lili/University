...
<%--        </li>--%>
        <li class="nav-item" role="presentation">
            <button class="nav-link active nav-pills-button" id="pills-scenic-favorites-tab" data-bs-toggle="pill" data-bs-target="#pills-scenic-favorites" type="button" role="tab" aria-controls="pills-scenic-favorites" aria-selected="true">我的景点收藏</button>
        </li>
        <li class="nav-item" role="presentation">
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-scenic-favorites" role="tabpanel">
